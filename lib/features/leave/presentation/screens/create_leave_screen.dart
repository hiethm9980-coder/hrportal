                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<int>(
                              ...
                              decoration: InputDecoration(errorText: form.fieldError('leave_type_id')),
                            ),
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              decoration: InputDecoration(errorText: form.fieldError('day_part')),
                            ),
                            const SizedBox(height: 14),
                            ...
                            TextFormField(
                              ...
                              style: GoogleFonts.cairo(fontSize: 13),
                              decoration: InputDecoration(errorText: form.fieldError('reason')),
                            ),
                          ],
                        ),
                      ),
